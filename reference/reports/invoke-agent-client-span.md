...
| --- | --- |
| gen_ai.operation.name | [a2a], [aws-bedrock-agent], [azure-ai-foundry], [google-genai], [openai-assistants] |
...
| Attribute | Supporting Libraries |
| --- | --- |
| gen_ai.agent.description | [a2a], [openai-assistants] |
| gen_ai.agent.id | [aws-bedrock-agent], [openai-assistants] |
| gen_ai.agent.name | [a2a], [azure-ai-foundry], [google-genai], [openai-assistants] |
| gen_ai.agent.version | [aws-bedrock-agent] |
| gen_ai.conversation.id | [a2a], [aws-bedrock-agent], [openai-assistants] |
| gen_ai.data_source.id | (none) |
| gen_ai.output.type | [azure-ai-foundry] |
| gen_ai.request.choice.count | (none) |
| gen_ai.request.seed | (none) |
| server.port | [a2a], [aws-bedrock-agent], [azure-ai-foundry], [openai-assistants] |
...
| server.address | [a2a], [aws-bedrock-agent], [azure-ai-foundry], [openai-assistants] |

## Opt-In

| Attribute | Supporting Libraries |
| --- | --- |
| gen_ai.input.messages | [a2a], [aws-bedrock-agent], [azure-ai-foundry], [openai-assistants] |
| gen_ai.output.messages | [a2a], [aws-bedrock-agent], [azure-ai-foundry], [openai-assistants] |
